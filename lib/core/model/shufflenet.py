    ...
    if pretrained:
        ...
        if model_url is None:
            ...
            for param_name in state_dict:
                if "stage" in param_name:
                    tensor_size=state_dict[param_name].size()

                    if len(tensor_size)==4 and tensor_size[2]==3 and tensor_size[3]==3:
                        state_dict[param_name]=torch.nn.functional.pad(state_dict[param_name],[1,1,1,1])
